...
local function generate(colors)
    ...
    return {
        ...
        float_bg = colors.float_bg or color.lighten(colors.bg, 0.97),
        ...
        -- Lualine colors
        bg_statusline = colors.bg_statusline or color.lighten(colors.bg, 0.95),
        fg_gutter = colors.fg_gutter or color.lighten(colors.bg, 0.70),
