...
function M.get(theme)
	return {
		...
		cssDefinition = { fg = theme.colors.purple, style = theme.options.bold_italic },
		...
		jsArrowFunction = { fg = theme.colors.purple, style = theme.options.bold_italic },
		...
		markdownId = { fg = theme.colors.purple, style = theme.options.bold_italic },
		markdownIdDeclaration = { fg = theme.colors.blue },
		markdownIdDelimiter = { link = "markdownId" },
		markdownItalic = { fg = theme.colors.purple, style = theme.options.italic },
		...
		pythonImport = { fg = theme.colors.purple, style = theme.options.bold_italic },
		...
		rubyClass = { fg = theme.colors.purple, style = theme.options.bold_italic },
		...
		sassInclude = { fg = theme.colors.purple, style = theme.options.bold_italic },
