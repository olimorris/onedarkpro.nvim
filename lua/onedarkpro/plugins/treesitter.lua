...
function M.get(theme)
	return {
		...
		TSFunction = { fg = theme.colors.blue, style = theme.config.styles.functions }, -- For function (calls and definitions).
		...
		TSKeyword = { fg = theme.colors.purple, style = theme.config.styles.keywords }, -- For keywords that don't fall in previous categories.
		TSKeywordFunction = { fg = theme.colors.purple, style = theme.config.styles.keywords }, -- For keywords used to define a fuction.
		TSKeywordOperator = { fg = theme.colors.purple, style = theme.options.italic }, -- For operators that are English words, e.g. `and`, `as`, `or`.
		...
		TSString = { fg = theme.colors.green, style = theme.config.styles.strings }, -- For strings.
		TSStringRegex = { fg = theme.colors.green, style = theme.config.styles.strings }, -- For regexes.
		TSStringEscape = { fg = theme.colors.cyan, style = theme.config.styles.strings }, -- For escape characters within a string.
		...
		TSVariable = { fg = theme.colors.red, style = theme.config.styles.variables }, -- Any variable name that does not have another highlight.
		TSVariableBuiltin = { fg = theme.colors.yellow, style = theme.options.italic }, -- Variable names that are defined by the languages, like `this` or `self`.
	}
end
