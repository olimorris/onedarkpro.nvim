...
function Logger.new(filename, opts)
  ...
  if log_info and log_info.size > LARGE then
    local warn_msg =
      string.format("OneDarkPro log is large (%d MB): %s", log_info.size / (1000 * 1000), logger._filename)
