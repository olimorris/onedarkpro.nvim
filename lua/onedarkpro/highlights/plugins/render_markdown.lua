...
function M.groups(theme)
    ...
    return {
        ...
        RenderMarkdownH1Bg = { bg = color.darken('red', 10, 'onedark')" },
        RenderMarkdownH2 = { fg = theme.palette.orange },
        RenderMarkdownH2Bg = { bg = color.darken('orange', 10, 'onedark')" },
        RenderMarkdownH3 = { fg = theme.palette.yellow },
        RenderMarkdownH3Bg = { bg = color.darken('yellow', 10, 'onedark')" },
        RenderMarkdownH4 = { fg = theme.palette.green },
        RenderMarkdownH4Bg = { bg = color.darken('green', 10, 'onedark')" },
        RenderMarkdownH5 = { fg = theme.palette.cyan },
        RenderMarkdownH5Bg = { bg = color.darken('cyan', 10, 'onedark')" },
        RenderMarkdownH6 = { fg = theme.palette.purple },
        RenderMarkdownH6Bg = { bg = color.darken('purple', 10, 'onedark')" },
