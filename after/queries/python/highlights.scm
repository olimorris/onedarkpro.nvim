...
(import_from_statement module_name: (relative_import (dotted_name (identifier) @odp.import_module)))
(import_from_statement name: (dotted_name (identifier) @odp.import_module))
