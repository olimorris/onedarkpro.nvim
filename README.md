...
> **Note:** The cache will be automatically generated if the `caching = true` and no cache file is present

To automatically re-generate the cache, an autocommand unique to your configuration could be used.
