...
vim.cmd("highlight CursorLineNrNCQuickFix guifg=#c678dd guibg=#282c34 gui=NONE guisp=NONE blend=NONE")
...
vim.cmd("highlight QuickFixLineNC guifg=NONE guibg=#282c34 gui=NONE guisp=NONE blend=NONE")
