...
vim.api.nvim_set_hl(0, "@constructor.python", { fg = "#56b6c2" })
...
vim.api.nvim_set_hl(0, "@function.call.ruby", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@function.macro.rust", { fg = "#d19a66" })
vim.api.nvim_set_hl(0, "@function.ruby", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@include.ruby", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@keyword.rust", { fg = "#c678dd" })
vim.api.nvim_set_hl(0, "@label.rust", { fg = "#abb2bf" })
vim.api.nvim_set_hl(0, "@method.call.javascript", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@method.call.python", { fg = "#e5c07b" })
vim.api.nvim_set_hl(0, "@method.javascript", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@operator.rust", { fg = "#abb2bf" })
vim.api.nvim_set_hl(0, "@parameter.markdown", { fg = "#abb2bf" })
vim.api.nvim_set_hl(0, "@parameter.ruby", { fg = "#abb2bf" })
vim.api.nvim_set_hl(0, "@parameter.rust", { fg = "#e06c75" })
vim.api.nvim_set_hl(0, "@property.toml", { fg = "#c678dd" })
vim.api.nvim_set_hl(0, "@punctuation.bracket.javascript", { fg = "#e5c07b" })
vim.api.nvim_set_hl(0, "@punctuation.delimiter.markdown", { fg = "#5c6370" })
...
vim.api.nvim_set_hl(0, "@text.literal.markdown", { fg = "#98c379" })
vim.api.nvim_set_hl(0, "@text.reference.markdown", { fg = "#61afef" })
vim.api.nvim_set_hl(0, "@text.title.markdown", { fg = "#e06c75" })
vim.api.nvim_set_hl(0, "@text.uri.markdown", { fg = "#98c379" })
vim.api.nvim_set_hl(0, "@variable.javascript", { fg = "#e06c75" })
...
vim.api.nvim_set_hl(0, "TSEmphasis", { fg = "#abb2bf" })
...
vim.api.nvim_set_hl(0, "TSStrong", { fg = "#abb2bf" })
...
vim.api.nvim_set_hl(0, "TSUnderline", { fg = "#abb2bf" })
